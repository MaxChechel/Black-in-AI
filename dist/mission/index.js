...
},{"./Observer.js":"../node_modules/gsap/Observer.js"}],"utils/gradientButton.js":[function(require,module,exports) {
"use strict";
...
function dotsPattern() {
  var patterns = document.querySelectorAll(".dots-pattern");
  patterns.forEach(function (pattern) {
    var circles = pattern.querySelectorAll("svg circle");
...
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js"}],"utils/gradientText.js":[function(require,module,exports) {
"use strict";
...
function gradientText(selector) {
  ...
  gradientChars.forEach(function (char, i) {
    var _char$previousElement;
    char.style.backgroundSize = char.parentElement.offsetWidth + "px 100%";
    offset += ((_char$previousElement = char.previousElementSibling) === null || _char$previousElement === void 0 ? void 0 : _char$previousElement.offsetWidth) || 0;
    char.style.backgroundPosition = char.parentElement.offsetWidth - offset + "px 0%";
  });
}
},{"gsap":"../node_modules/gsap/index.js","split-type":"../node_modules/split-type/dist/index.js"}],"mission/index.js":[function(require,module,exports) {
"use strict";
...
document.fonts.load('1em "Tt Hoves Pro Trial Variable"').then(function () {
  ...
  }, 0).to(".about-header_content-left a", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.55,
    ease: "circ.out"
  }, "<15%").to(".about-header_content-right p .split-line", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.55,
    ease: "circ.out",
  ...
  var statsContainers = document.querySelectorAll(".stats-mission_item-light");
  statsContainers.forEach(function (item, i) {
    var num = item.querySelectorAll(".stats-mission_number .char");
    var descr = item.querySelector("p");
    var tl = _gsap.default.timeline({
      delay: i * 0.05,
      ease: "circ.out",
      scrollTrigger: {
    ...
    tl.to(item, {
      ...
      y: "0%",
      autoAlpha: 1
    }, "<20%").to(".stats_component .button-group", {
      y: "0%",
      autoAlpha: 1,
      duration: 0.55
    }, "<10%");
  ...
  //////Tier sponsors
  var tierContainer = document.querySelectorAll(".tier-type_grid");
  tierContainer.forEach(function (container) {
    var heading = container.querySelector("h3");
    var divider = container.querySelector(".tier_divider");
    var logos = container.querySelectorAll(".sponsors-dark_item");
    _ScrollTrigger.default.create({
      trigger: container,
      start: "top 60%",
      end: "top 50%",
  ...
  /////Sponsors grantors
  var headerSections = _gsap.default.utils.toArray("[data-animate='philanthropic'], [data-animate='donors'], [data-animate='tiers-sponsors']");
  headerSections.forEach(function (section) {
    var heading = section.querySelectorAll("h2 .split-line");
    var text = section.querySelectorAll("p .split-line");
    var btn = section.querySelectorAll("a");
    _ScrollTrigger.default.create({
      trigger: section,
      start: "top 60%",
      end: "top 50%",
  ...
  _ScrollTrigger.default.create({
    ...
    onEnter: function onEnter() {
      var tl = _gsap.default.timeline();
      tl.to(".philantrophic_list .sponsors_wrapper", {
        autoAlpha: 1,
        duration: 0.8,
        ease: "circ.out",
        stagger: {
...
},{"gsap":"../node_modules/gsap/index.js","split-type":"../node_modules/split-type/dist/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js","../utils/gradientButton":"utils/gradientButton.js","../utils/ctaGradientBg":"utils/ctaGradientBg.js","../utils/gradientBg":"utils/gradientBg.js","../utils/dotsPattern":"utils/dotsPattern.js","../utils/imagesParallax":"utils/imagesParallax.js","../utils/gradientText":"utils/gradientText.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","mission/index.js"], null)
//# sourceMappingURL=/mission/index.js.map