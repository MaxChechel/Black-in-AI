...
})({"3VI0o":[function(require,module,exports) {
...
var _gradientText = require("../utils/gradientText");
var _gradientTextDefault = parcelHelpers.interopDefault(_gradientText);
(0, _gsapDefault.default).registerPlugin((0, _scrollTriggerDefault.default), (0, _splitTextDefault.default));
//Testimonial slider
...
(0, _scrollTriggerDefault.default).create({
    ...
    onEnter: ()=>{
        (0, _gsapDefault.default).to(".testimonial_bg-headshot-small, .testimonial_bg-headshot-medium", {
            opacity: 1,
            scale: 1,
            duration: 0.6,
            ease: "circ.out",
...
(0, _gradientTextDefault.default)(".stats-mission_number.gradient-text");
const statsItems = document.querySelectorAll(".stats-mission_item");
const split = new (0, _splitTextDefault.default)(".stats-mission_number:not(.gradient-text)", {
    type: "chars",
    charsClass: "char"
});
statsItems.forEach((item, i)=>{
    const num = item.querySelectorAll(".stats-mission_number .char");
    const descr = item.querySelector(".stats-mission_item .bg-gradient-text-clip") || item.querySelector(".stats-mission_item p");
...
//   });
//Hero
const splitHeroHeading = new (0, _splitTextDefault.default)("h1", {
    linesClass: "split-line"
});
const splitHeroParagraph = new (0, _splitTextDefault.default)(".home-header_content-wrap p", {
    linesClass: "split-line"
});
const heroBtns = document.querySelectorAll(".home-header_content-wrap .button-group a");
const heroBg = document.querySelector(".home-header_background-image");
(0, _gsapDefault.default).set("h1, .home-header_content-wrap p", {
    autoAlpha: 1
});
...
//2col section
const split2 = new (0, _splitTextDefault.default)("[data-animate='section-h'],[data-animate='section-p']", {
    type: "lines",
    linesClass: "split-line"
});
(0, _scrollTriggerDefault.default).create({
    ...
    onEnter: ()=>{
        const tl = (0, _gsapDefault.default).timeline();
        (0, _gsapDefault.default).set(".section_layout-2-col [data-animate='section-h'], .section_layout-2-col [data-animate='section-p']", {
            autoAlpha: 1,
            duration: 0
        });
...
(0, _scrollTriggerDefault.default).create({
    ...
    onEnter: ()=>{
        const tl = (0, _gsapDefault.default).timeline();
        (0, _gsapDefault.default).set(".section_cta [data-animate='section-h'], .section_cta [data-animate='section-p']", {
            autoAlpha: 1,
            duration: 0
        });
...
},{"gsap":"fPSuC","gsap/SplitText":"63tvY","gsap/ScrollTrigger":"7wnFk","../utils/gradientText":"1XMtU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1XMtU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>gradientText);
var _gsap = require("gsap");
var _gsapDefault = parcelHelpers.interopDefault(_gsap);
var _splitText = require("gsap/SplitText");
var _splitTextDefault = parcelHelpers.interopDefault(_splitText);
(0, _gsapDefault.default).registerPlugin((0, _splitTextDefault.default));
function gradientText(selector) {
    const childSplit = new (0, _splitTextDefault.default)(selector, {
        type: "chars",
        wordsClass: "word",
        charsClass: "char"
    });
    const gradientChars = document.querySelectorAll(".stats-mission_number.gradient-text .char");
    let offset = 0;
...
},{"gsap":"fPSuC","gsap/SplitText":"63tvY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3VI0o","jHaiW"], "jHaiW", "parcelRequire8029")
