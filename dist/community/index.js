...
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js"}],"community/index.js":[function(require,module,exports) {
"use strict";
...
document.fonts.load('1em "Tt Hoves Pro Trial Variable"').then(function () {
  ...
  //Split lines
  var splitLines = new _splitType.default("h1, .about-header_content-right p, [data-animate] h2, [data-animate] p, .team-header_component p, .team_row-wrap h3", {
    types: "lines",
  ...
  }, 0).to(".home-header_content-wrap .button-group a", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.55,
    ease: "circ.out",
  ...
  //////Slider
  var swiperWrap = document.querySelector(".swiper");
    ...
    _ScrollTrigger.default.create({
      ...
      onEnter: function onEnter() {
        ...
        tl.to(section.querySelector("h2"), {
          ...
          duration: 0.6,
          ease: "circ.out"
        }).to(section.querySelectorAll(".offering-list_item "), {
          y: "0%",
          autoAlpha: 1,
          duration: 0.6,
          ease: "circ.out",
  ...
  _ScrollTrigger.default.create({
    ...
    onEnter: function onEnter() {
      ...
      tl.to(".news_component h2", {
        ...
        duration: 0.6,
        ease: "circ.out"
      }).to(".news_component .news_button-row", {
        y: "0%",
        autoAlpha: 1,
        duration: 0.55,
        ease: "circ.out"
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","community/index.js"], null)
//# sourceMappingURL=/community/index.js.map