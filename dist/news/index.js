...
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js"}],"news/index.js":[function(require,module,exports) {
"use strict";
...
document.fonts.load('1em "Tt Hoves Pro Trial Variable"').then(function () {
  ...
  //Split lines
  var splitLines = new _splitType.default(".blog_featured-item-content h2, .blog_featured-item-content p, [data-animate] h2, [data-animate] h3", {
    types: "lines",
    lineClass: "split-line"
  });
  _gsap.default.set(".blog_featured-item-content h2, .blog_featured-item-content p, [data-animate] h2, [data-animate] h3", {
    opacity: 1
  });
  //////Hero
  ...
  heroTl.to("h1", {
    ...
    duration: 0.6,
    ease: "circ.out"
  }).to(".blog_featured-image", {
    scale: 1.04,
    opacity: 1
  }, "<25%").to(".blog_category-link", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.6
  }, "<25%").to(".blog_featured-item-content h2 .split-line", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.6,
    ease: "circ.out"
  }, "<25%").to(".blog_featured-item-content p .split-line", {
    y: "0%",
    autoAlpha: 1,
    duration: 0.55,
    ease: "circ.out",
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","news/index.js"], null)
